...
function main() {
  ...
  tableFromFile.addPhysics(); // nach dem Positionieren des Tisches!
  window.scene.add(tableFromFile);

  const plantFromFile = new PlantFromFile();
  plantFromFile.position.set(-60, 75, -75);
  plantFromFile.addPhysics(); // nach dem Positionieren des Tisches!
