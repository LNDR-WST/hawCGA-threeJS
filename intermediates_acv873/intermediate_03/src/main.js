...
function main() {
  ...
  gui.add(sphere.position, 'y', -50, 50).onChange(function(e) {cube.position.y = e;});

  let proxies = {z_pos: 0};
  gui.add(proxies, 'z_pos', -50, 50).onChange(function(e) {cube.position.z = e; sphere.position.z = e;});
