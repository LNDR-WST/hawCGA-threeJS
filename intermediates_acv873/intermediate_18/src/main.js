...
function main() {
  ...
  function mainLoop() {
    ...
    if (window.powerOn) {
      if(television.children[3].children[0].rotation.y > THREE.MathUtils.degToRad(-90)) {
        //television.children[3].children[0].rotation.y -= THREE.MathUtils.degToRad(5);
        television.children[3].children[0].rotation.y -= THREE.MathUtils.degToRad(360) * delta; // Delta = Kehrwert der Framerate
      } else {
        television.children[3].children[0].rotation.y = THREE.MathUtils.degToRad(-90);
      }
    } else {
      if(television.children[3].children[0].rotation.y < 0) {
        //television.children[3].children[0].rotation.y += THREE.MathUtils.degToRad(5);
        television.children[3].children[0].rotation.y += THREE.MathUtils.degToRad(360) * delta;
      } else {
        television.children[3].children[0].rotation.y = 0;
      }
    }
  }
